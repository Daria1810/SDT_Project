...
/**
 * Spring wiring for shared infrastructure.
 * Exposes a DataSource and NamedParameterJdbcTemplate backed by our single connection provider.
 */
@Configuration
public class AppConfig {
    ...
    /**
     * JDBC helper for parameterized SQL.
     */
    @Bean
